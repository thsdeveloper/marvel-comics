    ...
    <>
      ...
      >
        <Stack alignItems="center" spacing={10}>
          ...
          <Box boxSize={['xs', 'sm']} pos="relative">
            <Image
          ...
          <Text color="gray.500" w="full">
            {serie.description !== null
              ? serie.description
              : 'No brief description available for this serie. Check out the information links below.'}
          </Text>
            ...
            <Stack color="gray.500">
              ...
              <List>
                {serie.characters.items.map((character) => (
                  <ListItem key={character.resourceURI}>
                    {character.name}
                  </ListItem>
                ))}
                {serie.characters.items.length === 0 &&
                  'No character found for this series.'}
              </List>
            </Stack>
            <Stack color="gray.500">
